...
public class UserSettingsResponseDTO {
    ...
    public UserSettingsResponseDTO(UserSetting setting) {
    ...
    public static class Workspace {
        ...
        public Workspace(UserSetting setting) {
            //check if null
            this.workspaceName = setting.getWorkspaceName() == null ? setting.getUser().getFullName() + " WorkSpace" : setting.getWorkspaceName();
        }
    }
}
